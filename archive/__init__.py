...
from archive.resources.spotify import ArtistsAPI, ArtistsTracksAPI, LastFmArtistsAPI
...
# LastFM
api.add_resource(LastFmArtistsAPI, '/api/lastfm/artists', endpoint='lastfm_artists_api')

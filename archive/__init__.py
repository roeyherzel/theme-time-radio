...
from archive.resources.albums import *
...
api.add_resource(ApiTracksAlbums, '/api/tracks/<int:track_id>/match/album', endpoint='tracks_albums_api')
...
api.add_resource(ApiArtistsAlbums, '/api/artists/<int:artist_id>/albums', endpoint='artist_albums_api')
...
# Album
api.add_resource(ApiAlbum, '/api/albums', '/api/albums/<int:album_id>', endpoint='albums_api')
api.add_resource(ApiAlbumsArtists, '/api/albums/<int:album_id>/artists', endpoint='album_artists_api')
api.add_resource(ApiAlbumsEpisodes, '/api/albums/<int:album_id>/episodes', endpoint='albums_episodes_api')
api.add_resource(ApiTopAlbums, '/api/albums/top', endpoint='top_albums_api')
